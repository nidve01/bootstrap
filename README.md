...
```
5. Register the qubeship apps with your github using below github configuration https://github.com/Qubeship/bootstrap/blob/US346719_oauthreg_timeout_inst/README.md#github-configuration
----
## Install
